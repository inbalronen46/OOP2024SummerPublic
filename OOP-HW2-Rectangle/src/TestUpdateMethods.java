...
public class TestUpdateMethods {
	...
	public void testReflectYAxis() {
		Set<Point> expectedPoints;
		Set<Point> actualPoints;
		rectangle2.reflect(false, true);
		assertEquals(2, rectangle2.getHeight(), HW2Utils.getPRECISION());
		assertEquals(3, rectangle2.getWidth(), HW2Utils.getPRECISION());
		assertEquals(rectangle2.getBottomLeft(), new Point(-4.0, 2));
    	...
    	rectangle5.reflect(false, true);
		assertEquals(2, rectangle5.getHeight(), HW2Utils.getPRECISION());
		assertEquals(3, rectangle5.getWidth(), HW2Utils.getPRECISION());
		assertEquals(rectangle5.getBottomLeft(), new Point(-4.0, 2));
		expectedPoints = new HashSet<Point>(Arrays.asList(
				new Point(-1, 4),                   
                new Point(-4, 4),                  
                new Point(-4, 2),                   
		...
		actualPoints = new HashSet<Point>(Arrays.asList(rectangle3.getAllPoints()));
    	assertEquals(expectedPoints, actualPoints);
    	
    	rectangle6.reflect(false, true);
		assertEquals(3, rectangle6.getHeight(), HW2Utils.getPRECISION());
		assertEquals(2, rectangle6.getWidth(), HW2Utils.getPRECISION());
		assertEquals(rectangle6.getBottomLeft(), new Point(-1.0, -2.0));
		expectedPoints = new HashSet<Point>(Arrays.asList(
	...
	@Test
	public void testRefelctXAxis() {
		rectangle2.reflect(true, false);
		assertEquals(2, rectangle2.getHeight(), HW2Utils.getPRECISION());
		assertEquals(3, rectangle2.getWidth(), HW2Utils.getPRECISION());
		assertEquals(rectangle2.getBottomLeft(), new Point(1.0, -4.0));
    	...
    	rectangle5.reflect(true, false);
		assertEquals(2, rectangle5.getHeight(), HW2Utils.getPRECISION());
		assertEquals(3, rectangle5.getWidth(), HW2Utils.getPRECISION());
		assertEquals(rectangle5.getBottomLeft(), new Point(1.0, -4.0));
		expectedPoints = new HashSet<>(Arrays.asList(
                new Point(1, -4),                   // Top-left
                new Point(4, -4),                  // Top-right
                new Point(4, -2),                   // Bottom-right
    	...
    	rectangle3.reflect(true, false);
		assertEquals(3, rectangle3.getHeight(), HW2Utils.getPRECISION());
		assertEquals(2, rectangle3.getWidth(), HW2Utils.getPRECISION());
		assertEquals(rectangle3.getBottomLeft(), new Point(-1.0, -1.0));
		expectedPoints = new HashSet<Point>(Arrays.asList(
                new Point(-1, -1),                   
                new Point(1, 2),                  
                new Point(-1, 2),                   
    	...
    	rectangle6.reflect(true, false);
		assertEquals(3, rectangle6.getHeight(), HW2Utils.getPRECISION());
		assertEquals(2, rectangle6.getWidth(), HW2Utils.getPRECISION());
		assertEquals(rectangle6.getBottomLeft(), new Point(-1.0, -1.0));
		expectedPoints = new HashSet<Point>(Arrays.asList(
                new Point(-1, -1),                   
                new Point(1, 2),                  
                new Point(-1, 2),                   
	...
	@Test
	public void testReflectBoth() {
		Set<Point> expectedPoints;
		Set<Point> actualPoints;
		rectangle2.reflect(true, true);
		assertEquals(2, rectangle2.getHeight(), HW2Utils.getPRECISION());
		assertEquals(3, rectangle2.getWidth(), HW2Utils.getPRECISION());
		assertEquals(rectangle2.getBottomLeft(), new Point(-4.0, -4.0));
		expectedPoints = new HashSet<>(Arrays.asList(
                new Point(-1, -4),                   
                new Point(-4, -4),                  
                new Point(-4, -2),                   
		...
		actualPoints = new HashSet<Point>(Arrays.asList(rectangle2.getAllPoints()));
    	assertEquals(expectedPoints, actualPoints);
    	
    	rectangle5.reflect(true, true);
		assertEquals(2, rectangle5.getHeight(), HW2Utils.getPRECISION());
		assertEquals(3, rectangle5.getWidth(), HW2Utils.getPRECISION());
		assertEquals(rectangle5.getBottomLeft(), new Point(-4.0, -4.0));
		expectedPoints = new HashSet<Point>(Arrays.asList(
				new Point(-1, -4),                   
                new Point(-4, -4),                  
                new Point(-4, -2),                   
